...
namespace Modbus.ModbusFunctions
{
    ...
    /// Upisivanje pojedinacnog digitalnog signala
    /// </summary>
    public class WriteSingleCoilFunction : ModbusFunction
    {
        ...
        public override Dictionary<Tuple<PointType, ushort>, ushort> ParseResponse(byte[] response)
        {
            ...
            // adresa upisanpg signala iz odgovora se nalazi na poziciji 8 u response nizu
            // adresa je 2 bajta, osma i deveta poz
            // vrednost se nalazi na poziciji 10 u odgovoru
            // vrednost takodje 2 bajta 
